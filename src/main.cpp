...
int main () {
    ...
    //sphere.t = translate(Vec3(0.0, 0.0, 2.0));
    s->objects.objects[1]->t = translate(Vec3(0.0, 0.0, 2.0));
    //s->addObject(&sphere);
    ...
    s->addLight(new PointLight(Vec3(5.07625, -2.99455, 5.90386), SpectralQuantity(0.7, 0.7, 0.7)));
